        ...
        <main className="flex min-h-screen flex-col items-center p-24">
            ...
            <form className="justify-center">
                ...
                <div className="flex justify-center">
                    <input
                        type="submit"
                        className="block border border-gray-300 rounded px-2 py-1 my-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
